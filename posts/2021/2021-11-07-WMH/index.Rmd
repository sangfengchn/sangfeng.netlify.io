...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-11-07-WMH/img/fig_01.png')
```
...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-11-07-WMH/img/fig_02.png')
```

## 部分分割结果

```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-11-07-WMH/img/fig_03.png')
```
