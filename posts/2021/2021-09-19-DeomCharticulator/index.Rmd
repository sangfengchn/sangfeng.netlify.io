...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-09-19-DeomCharticulator/img/fig-01.png')
```

link.csv中必须包含source_id和target_id列，其值为node.csv中id的值。link.csv中每一行表示和弦图中一条连边。同样，其他列为可选列，可以指定和弦图中连边的宽度等。

```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-09-19-DeomCharticulator/img/fig-02.png')
```
...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-09-19-DeomCharticulator/img/fig-03.gif')
```
...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-09-19-DeomCharticulator/img/fig-04.gif')
```
...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-09-19-DeomCharticulator/img/fig-05.gif')
```
...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-09-19-DeomCharticulator/img/fig-06.gif')
```
...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-09-19-DeomCharticulator/img/fig-07.gif')
```
