...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-11-20-PythonForNeuroimage/img/fig_03.png')
```
...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-11-20-PythonForNeuroimage/img/fig_04.png')
```
...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-11-20-PythonForNeuroimage/img/fig_05.png')
```
...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-11-20-PythonForNeuroimage/img/fig_06.png')
```
...
这里以ANTs去除非脑组织为例。ANTs去非脑组织的过程是通过配准来实现的，需要事先提供[带颅骨的模版](file://posts/2021/2021-11-20-PythonForNeuroimage/file/T_template0.nii.gz)和只包含[脑组织的模版](file://posts/2021/2021-11-20-PythonForNeuroimage/file/T_template0_BrainCerebellumMask.nii.gz)。
...
```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-11-20-PythonForNeuroimage/img/fig_01.png')
```

结果图像：

```{r, echo=FALSE}
knitr::include_graphics('posts/2021/2021-11-20-PythonForNeuroimage/img/fig_02.png')
```
