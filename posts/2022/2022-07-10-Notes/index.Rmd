...
knitr::include_graphics('posts/2022/2022-07-10-Notes/img/demo.png')
```
...
knitr::include_graphics('posts/2022/2022-07-10-Notes/img/demo-round.png')
```

```{r fig-butt, echo = FALSE, fig.cap='这是butt。'}
knitr::include_graphics('posts/2022/2022-07-10-Notes/img/demo-butt.png')
```

```{r fig-square, echo = FALSE, fig.cap='这是square。'}
knitr::include_graphics('posts/2022/2022-07-10-Notes/img/demo-square.png')
```
...
knitr::include_graphics('posts/2022/2022-07-10-Notes/img/demo-label.png')
```
